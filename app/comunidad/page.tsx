...
export default function LocationPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-2">Nuestra comunidad</h1>
      <p className="text-muted-foreground mb-8">
        Ingresa a nuestra comunidad y mantente al tanto de las últimas novedades, eventos y promociones.
      </p>
      
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        <div className="bg-black text-white p-8 rounded-lg col-span-1 lg:col-span-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="relative">
              <Image
                src="/images/fondoComunidad.png"
                alt="Comunidad Clazoni"
                width={500}
                height={500}
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <h2 className="text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-300 animate-pulse mb-6 text-center">
