...
export const instrumentsData: Instrument[] = [
  {
    ...
    descripcion: "La Fender Stratocaster es una guitarra eléctrica de cuerpo sólido, conocida por su sonido brillante y versátil, ideal para diversos géneros musicales desde blues hasta rock y más allá.",
    price: 12999
  },
  {
    id: "2",
    ...
    descripcion: "El Fender Jazz Bass ofrece un tono rico y versátil con su configuración de pastillas divididas, perfecto para cualquier estilo musical desde funk hasta rock.",
    price: 14599
  },
  {
    id: "3",
    ...
    descripcion: "El saxofón alto Yamaha es conocido por su excelente afinación, respuesta rápida y sonido cálido, ideal tanto para estudiantes como para profesionales.",
    price: 22500
  },
  {
    id: "4",
    ...
    descripcion: "La trompeta Bach Stradivarius es el estándar de excelencia para músicos profesionales, ofreciendo un sonido brillante y una excelente respuesta.",
    price: 19999
  },
  {
    id: "5",
    ...
    descripcion: "La batería Yamaha Stage Custom ofrece cascos de abedul con un sonido cálido y potente, ideal para diversos estilos musicales desde jazz hasta rock.",
    price: 32000
  },
  {
    id: "6",
    ...
    descripcion: "El cajón LP ofrece un sonido auténtico con graves potentes y agudos nítidos, perfecto para flamenco y música acústica.",
    price: 3500
  },
  {
    id: "7",
    ...
    descripcion: "El Clavinova de Yamaha ofrece una experiencia similar al piano acústico con muestreo de instrumento de alta calidad y un tacto auténtico.",
    price: 41999
  },
  {
    id: "8",
    ...
    descripcion: "La estación de trabajo Roland Fantom combina sintetizador, secuenciador y controlador en uno, ofreciendo sonidos realistas e infinitas posibilidades creativas.",
    price: 52000
  },
  {
    id: "9",
    ...
    descripcion: "El controlador MIDI Komplete Kontrol ofrece una integración perfecta con software de producción musical y una excelente sensación de teclas.",
    price: 12900
  },
  {
    id: "10",
    ...
    descripcion: "La interfaz Scarlett ofrece preamplificadores de alta calidad y baja latencia para grabaciones profesionales en casa o estudio.",
    price: 4599
  },
  {
    id: "11",
    ...
    descripcion: "Violín de tamaño completo con tono cálido y rica resonancia, ideal tanto para estudiantes avanzados como para profesionales.",
    price: 18500
  },
  {
    id: "12",
    ...
    descripcion: "Flauta traversa profesional con cabeza y cuerpo de plata, ofreciendo un sonido brillante y una respuesta rápida.",
    price: 15999
  }
];
